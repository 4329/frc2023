...
public class SwerveAlignment {
        ...
        public void initSwerveAlignmentWidgets() {
                if (Configrun.get(false, "extraShuffleBoardToggle")) {
                        ...
                        Shuffleboard.getTab(SWERVE_ALIGNMENT).add("Documentation",
                                        ...
                                        .withPosition(7, 1).withSize(4, 2).withWidget(BuiltInWidgets.kTextView)
                                        .getEntry();
                        // Front left
                        ...
                        backLeftRawAngleDisplay = Shuffleboard.getTab(SWERVE_ALIGNMENT)
                                        .add("BL Raw Angle",
                                        m_dDrivetrain.getBackLeftAngle() - DriveConstants.kBackLeftOffset)
        ...
        public void updateSwerveAlignment() {
                if (Configrun.get(false, "extraShuffleBoardToggle")) {
                        ...
                        frontLeftRawAngleDisplay
                                        .setDouble(m_dDrivetrain.getFrontLeftAngle() - DriveConstants.kFrontLeftOffset);
                        // frontLeftOffsetDisplay.setDouble(DriveConstants.kFrontLeftOffset);
                        frontLeftAlignmentDisplayDeg
                                        .setDouble(Math.toDegrees(
                                                        m_dDrivetrain.getFrontLeftAngle() - frontLeftInitialAngle));
                        frontLeftAlignmentDisplayRad
                                        .setDouble(m_dDrivetrain.getFrontLeftAngle() - frontLeftInitialAngle);
                        // Front right
                        frontRightAngleDisplay.setDouble(m_dDrivetrain.getFrontRightAngle());
                        frontRightRawAngleDisplay.setDouble(
                                        m_dDrivetrain.getFrontRightAngle() - DriveConstants.kFrontRightOffset);
                        // frontRightOffsetDisplay.setDouble(DriveConstants.kFrontRightOffset);
                        frontRightAlignmentDisplayDeg
                                        .setDouble(Math.toDegrees(
                                                        m_dDrivetrain.getFrontRightAngle() - frontRightInitialAngle));
                        frontRightAlignmentDisplayRad
                                        .setDouble(m_dDrivetrain.getFrontRightAngle() - frontRightInitialAngle);
                        // Back left
                        backLeftAngleDisplay.setDouble(m_dDrivetrain.getBackLeftAngle());
                        backLeftRawAngleDisplay
                                        .setDouble(m_dDrivetrain.getBackLeftAngle() - DriveConstants.kBackLeftOffset);
                        // backLeftOffsetDisplay.setDouble(DriveConstants.kBackLeftOffset);
                        backLeftAlignmentDisplayDeg.setDouble(
                                        Math.toDegrees(m_dDrivetrain.getBackLeftAngle() - backLeftInitialAngle));
                        ...
                        backRightRawAngleDisplay
                                        .setDouble(m_dDrivetrain.getBackRightAngle() - DriveConstants.kBackRightOffset);
                        // backRightOffsetDisplay.setDouble(DriveConstants.kBackRightOffset);
                        backRightAlignmentDisplayDeg
                                        .setDouble(Math.toDegrees(
                                                        m_dDrivetrain.getBackRightAngle() - backRightInitialAngle));
                        backRightAlignmentDisplayRad
                                        .setDouble(m_dDrivetrain.getBackRightAngle() - backRightInitialAngle);
                }
        }
}
